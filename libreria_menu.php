...
if (isset($_SESSION["sesion_id_rol"])){
    $sql1 = $db->Prepare("SELECT nombre, logo
        ...
        if ($cuerp==false){
            echo"<img src='../empresa/logos/{$logo}' width='10%' >";
        }
        else {
            echo"<img src='privada/empresa/logos/{$logo}' width='10%' >";
        }
                ...
                foreach ($rs as $r => $fila) {
                    ...
                    if ($cuerp == false or $cuerp == ""){
                        echo"<li><a onclick='location.href=\"../".$fila2["contenido"]."\"' ' style='cursor:pointer;'>".$fila2["opcion"]."</a></li>";
                                ...
                                echo"<li><a onclick='location.href=\"sis_segundo_2022/".$fila2["contenido"]."\"'  style='cursor:pointer;'>".$fila2["opcion"]."</a></li>";
                }
        }
        echo"</ul>";
    echo"</li>";
