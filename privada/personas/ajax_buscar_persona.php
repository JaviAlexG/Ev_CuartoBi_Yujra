...
if($nombres or $materno or $paterno or $ci){
   $sql3 = $db->Prepare("SELECT *
    ...
    if($rs3){
        ...
        <table class='listado'>
            <tr>
                <th>CI</th><th>PATERNO</th><th>MATERNO</th><th>NOMBRES<th><img src'../../imagenes/modificar.gif'></th><th img src='../../imagenes/borrar.jpeg'></th>
            </tr>";
