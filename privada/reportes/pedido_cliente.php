...
echo "<html>
        <head>
            ...
            function validar() {
                ...
                ventanaCalendario=window.open('pedido_cliente1.php?fecha1=' + fecha1 + '&fecha2=' +fecha2 , 'calendario', 'width=600, heigth=550, left=100, top=100,scrollbars=yes,menubars=no, statusbar=NO,status=NO,resizable=YES,location=NO')
            }
        </script>
    </head>
